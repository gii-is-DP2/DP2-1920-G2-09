...
public class VetValidatorTests {
	...
	void shouldNotValidateWhenFirstNameEmpty() {
		...
		Errors errors = new BeanPropertyBindingResult(this.vet, "");
		vv.validate(this.vet, errors);
		Assertions.assertThat(errors.getFieldError("firstName").getCode()).isEqualTo("required and between 3 and 50 characters");
	}
	...
	void shouldNotValidateFirstNameIsLongerThan50Characters() {
		this.vet.setFirstName("Demasiadoooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooos caracteres");
		VetValidator vv = new VetValidator();
		Errors errors = new BeanPropertyBindingResult(this.vet, "");
		vv.validate(this.vet, errors);
		Assertions.assertThat(errors.getFieldError("firstName").getCode()).isEqualTo("required and between 3 and 50 characters");
	...
	void shouldNotValidateWhenLastNameEmpty() {
		...
		Errors errors = new BeanPropertyBindingResult(this.vet, "");
		vv.validate(this.vet, errors);
		Assertions.assertThat(errors.getFieldError("lastName").getCode()).isEqualTo("required and between 3 and 50 characters");
	}
	...
	void shouldNotValidateLastNameIsLongerThan50Characters() {
		this.vet.setLastName("Demasiadoooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooos caracteres");
		VetValidator vv = new VetValidator();
		Errors errors = new BeanPropertyBindingResult(this.vet, "");
		vv.validate(this.vet, errors);
		Assertions.assertThat(errors.getFieldError("lastName").getCode()).isEqualTo("required and between 3 and 50 characters");
	...
	void shouldNotValidateWhenUsernameEmpty() {
		...
		Errors errors = new BeanPropertyBindingResult(this.vet, "");
		vv.validate(this.vet, errors);
		Assertions.assertThat(errors.getFieldError("user.username").getCode()).isEqualTo("required and between 3 and 20 characters");
	}
	...
	void shouldNotValidateWhenPasswordEmpty() {
		...
		Errors errors = new BeanPropertyBindingResult(this.vet, "");
		vv.validate(this.vet, errors);
		Assertions.assertThat(errors.getFieldError("user.password").getCode()).isEqualTo("required and between 3 and 50 characters");
	}
	...
	void shouldNotValidatePasswordIsLongerThan50Characters() {
		this.vet.getUser().setUsername("Demasiadoooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooos caracteres");
		VetValidator vv = new VetValidator();
		Errors errors = new BeanPropertyBindingResult(this.vet, "");
		vv.validate(this.vet, errors);
		Assertions.assertThat(errors.getFieldError("user.password").getCode()).isEqualTo("required and between 3 and 50 characters");

...
class ActualizaProductoNegativoUITest {
	...
	@Test
	void testActualizaProductoNegativoUI() throws Exception {
	...
	public void assertElements() throws Exception {
		Assert.assertTrue(this.isElementPresent(By.cssSelector("span.help-inline")));

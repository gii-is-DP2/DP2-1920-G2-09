...
class AñadirVeterinarioUITest {
	...
	@Test
	void testAñadirVeterinarioUI() throws Exception {
	...
	public void completeForm() {
		...
		this.driver.findElement(By.id("lastName")).sendKeys("Fernadez");
	...
	public void assertElements() {
		int filas = this.driver.findElement(By.id("vetsTable")).findElements(By.tagName("tr")).size() - 1;
		Assert.assertEquals("Adrian Fernadez",
				this.driver.findElement(By.xpath("(//td[@id='NameVet'])[" + filas + "]")).getText());
		Assert.assertEquals("surgery",
				this.driver.findElement(By.xpath("(//td[@id='specialtyVet'])[" + filas + "]")).getText());
	}
}

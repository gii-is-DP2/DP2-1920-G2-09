...
public class ComentaProductoUITest {
  ...
  public void testComentaProductoUI() throws Exception {
    ...
    assertEquals("owner1", driver.findElement(By.xpath("(//strong[@id='usuarioComentario'])["+comentarios+"]")).getText());
    assertEquals("Comentario UITest", driver.findElement(By.xpath("(//strong[@id='tituloComentario'])["+comentarios+"]")).getText());
    assertEquals("Este es un comentario para el UITest", driver.findElement(By.xpath("(//p[@id='descriptionComentario'])["+comentarios+"]")).getText());
    assertEquals(LocalDate.now().toString(),driver.findElement(By.xpath("(//small[@id='fechaComentario'])["+comentarios+"]")).getText());
  }

...
class AñadirProductoNegativoUITest {
	...
	@Test
	void testAñadirProductoNegativoUI() throws Exception {
	...
	public void completeForm() throws Exception {
		...
		this.driver.findElement(By.id("name")).sendKeys("Titulo caso Negativo");
		...
		this.driver.findElement(By.name("stock")).sendKeys("60");
		this.driver.findElement(By.id("urlImage")).clear();
		this.driver.findElement(By.id("urlImage")).sendKeys("https://images.app.goo.gl/8336dBbsrkshuMvo8");
	...
	public void assertElements() throws Exception {
		Assert.assertTrue(this.isElementPresent(By.xpath("//form[@id='add-product-form']/div/div[5]/div/span[2]")));
	}
}

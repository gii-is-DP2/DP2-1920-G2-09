...
public class AñadirPaseoUITest {
  ...
  public void testAñadirPaseoUI() throws Exception {
    ...
    assertEquals("https://images.app.goo.gl/y6xogjo3eKaDjwjs8", driver.findElement(By.xpath("(//img[@id='walkMap'])["+walks+"]")).getAttribute("src") );
    assertEquals("Prueba UITest", driver.findElement((By.xpath("(//div[@id='walkName'])["+walks+"]"))).getText());

...
class EliminaComentarioUITest {
	...
	@Test
	void testEliminaComentarioUI() throws Exception {
	...
	public void deleteElement() {
		...
		this.comentarios = this.driver.findElement(By.id("comentarios")).findElements(By.tagName("li")).size();
		this.driver.findElement(By.linkText("Eliminar Comentario")).click();
	}

	public void assertElements() {
		Assert.assertEquals(this.comentarios - 1,
				this.driver.findElement(By.id("comentarios")).findElements(By.tagName("li")).size());
	}
}

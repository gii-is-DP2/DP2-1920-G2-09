	...
	<thead>
        ...
        <td>
         ...
         <c:out value="${item.quantity}"/>
                 ...
                 <td >
         <c:out value="${item.unitPrice} euros"/>
         </td>
         
         <td>
         <c:out value="${item.unitPrice*item.quantity} euros"/>
         </td>
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                            ...
                            <span class="text-muted pull-left">
                                 <strong class="text-success"><c:out value = "Number of products: ${totalQuantity}"  /></strong> <br>
                         
                                </span>
                                <span class="text-muted pull-right">
                                 <strong class="text-success"><c:out value = "Total Price: ${total} euros"/></strong> <br>
                                </span>
                               
                               <form:form modelAttribute="shoppingCart" class="form-horizontal" id="buy-form" action = "/shopping-cart/buy">
                               <div class="form-group has-feedback">
                               </div>
                               <div class="text-muted pull-2">
                               <button class="btn btn-default" type="submit">Buy Products</button>                   
           						 </div>	
                               </form:form>
                            </div>
                </div>
